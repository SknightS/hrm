...
<!-- Mirrored from dreamguys.co.in/smarthr/blue/employees.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Oct 2018 15:26:35 GMT -->
<head>
        <meta charset="utf-8">
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul class="list-unstyled" style="display: none;">
									<li><a class="active" href="employees.php">All Employees</a></li>
					...
					<div class="row staff-grid-row">
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="profile.php">John Doe</a></h4>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="profile.php">Richard Miles</a></h4>
