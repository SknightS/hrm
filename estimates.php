...
<!-- Mirrored from dreamguys.co.in/smarthr/blue/estimates.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Oct 2018 15:26:40 GMT -->
<head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
        <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.png">
        <title>Estimate - HRMS admin template</title>
                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-sm-4 text-right m-b-30">
							<a href="create-estimate.php" class="btn btn-primary rounded"><i class="fa fa-plus"></i> Create New Estimate</a>
						</div>
					</div>
										...
										<tr>
											...
											<td class="text-right">
												<div class="dropdown">
													...
													<ul class="dropdown-menu pull-right">
														<li><a href="edit-estimate.php"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
...
<!-- Mirrored from dreamguys.co.in/smarthr/blue/estimates.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Oct 2018 15:26:41 GMT -->
</html>