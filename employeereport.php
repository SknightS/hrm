...
<!-- Mirrored from dreamguys.co.in/smarthr/blue/Report.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Oct 2018 15:26:41 GMT -->
...
<!--                    <a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_Report"><i class="fa fa-plus"></i> Add Report</a>-->
<!--                </div>-->
            </div>
        ...
        <div class="nReportification-box">
            <div class="msg-sidebar nReportifications msg-nReporti">
                ...
                <div class="topnav-dropdown-foReporter">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content modal-lg">
                <div class="modal-header">
                    <h4 class="modal-title">Add Staff Report</h4>
                </div>
...
<script type="text/javascript" src="assets/js/boReportstrap.min.js"></script>
<script type="text/javascript" src="assets/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="assets/js/dataTables.boReportstrap.min.js"></script>
<script type="text/javascript" src="assets/js/jquery.slimscroll.js"></script>
<script type="text/javascript" src="assets/js/select2.min.js"></script>
<script type="text/javascript" src="assets/js/moment.min.js"></script>
<script type="text/javascript" src="assets/js/boReportstrap-datetimepicker.min.js"></script>
